...
if (empty($trackingNumber) || !preg_match('/^[A-Za-z0-9-]+$/', $trackingNumber)) {
    ...
    echo '<!DOCTYPE html><html><head><title>Invalid Tracking Number</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"></head><body class="bg-light"><div class="container py-5"><div class="alert alert-danger text-center"><i class="fas fa-exclamation-triangle me-2"></i>Invalid tracking number.</div></div></body></html>';
    exit();
}
